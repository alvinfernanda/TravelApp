...
public class DatePicker extends AsyncTask<Location, Void, String> {

    private final String TAG = DatePicker.class.getSimpleName();
    private Context mContext;

    private OnTaskCompleted mListener;

    DatePicker(Context applicationContext, DatePicker.OnTaskCompleted listener) {
