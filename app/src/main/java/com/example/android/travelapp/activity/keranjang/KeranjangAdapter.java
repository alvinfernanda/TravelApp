...
public class KeranjangAdapter extends RecyclerView.Adapter<KeranjangAdapter.RecyclerViewAdapter> {

    private Context context;
    private List<Tiket> tikets;
    private ItemClickListener itemClickListener;

    public KeranjangAdapter(Context context, List<Tiket> tikets, ItemClickListener itemClickListener) {
    ...
    public RecyclerViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_tiket,
                parent, false);
